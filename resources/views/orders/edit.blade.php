...
{{--          action="{{ route('orderEdit', $id) }}"--}}
{{--          action="{{ route('orderEdit', [$gameAlias, $serviceAlias]) }}"--}}
{{--          method="post"--}}
...
{{--                    <div class="form-group col-6">--}}
{{--                        <input name="cost" type="text" class="form-control" placeholder="Стоимость" value="{{ $order->balance }}">--}}
{{--                    </div>--}}
